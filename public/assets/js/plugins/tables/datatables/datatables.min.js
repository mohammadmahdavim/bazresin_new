...
sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"First",sLast:"Last",sNext:"Next",sPrevious:"Previous"},sEmptyTable:"No data available in table",sInfo:"نمایش _START_ از _END_ از مقدار _TOTAL_ رکورد",sInfoEmpty:"نمایش 0 از 0 از مقدار 0 کل رکورد",sInfoFiltered:"(فیلتر شده از _MAX_  رکورد)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Show _MENU_ entries",sLoadingRecords:"صبرکنید...",sProcessing:"درحال چردازش...",sSearch:"جست و جو:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"هیچ رکوردی یافت نشد"},
