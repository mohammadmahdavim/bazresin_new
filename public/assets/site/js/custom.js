...
//============== Header Search
    ...
    $("#testimonial_agency").owlCarousel({
        navigationText :["<i class='flaticon-right-arrow'></i>", "<i class='flaticon-left-arrow'></i>"],
        items : 2,
        itemsDesktop : [1199, 2],
        itemsDesktopSmall : [980, 2],
        itemsTablet: [768, 1],
    ...
    $('#marketing_testimonial').slick({
        prevArrow: "<a href='#'><i class='flaticon-right-arrow icon_left'></i></a>",
    ...
    $('.slider-for').slick({
        ...
        arrows: true,
        prevArrow: "<a href='#'><i class='flaticon-right-arrow icon_left'></i></a>",
        nextArrow: "<a href='#'><i class='flaticon-left-arrow icon_right'></i></a>",
        fade: false,
        asNavFor: '.slider-nav'
    });
    $('.slider-nav').slick({
