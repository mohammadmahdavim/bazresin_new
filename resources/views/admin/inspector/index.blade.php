        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h5 class="modal-title">بروزرسانی بازرس ها از طریق آپلود اکسل</h5>
                </div>
                ...
                <div class="modal-footer">
                    ...
                    <a href="/admin/inspector/upload" class="btn btn-primary">آپلود</a>
                </div>
