            ...
            <table class="table table-bordered table-striped table-hover bg-active-700" id='myTable'>
                ...
                @foreach ($records as $key=>$record)
                    ...
                    >
                        ...
                        <td>
                            <a class="btn btn-warning btn-sm" onclick="getMark('{{$azmoon->id}}','{{$record->poshtiban_code}}')"><i
                                    class="icon-law" ></i></a>
                        </td>
                        <td>
                            @if($record->status == 1)
                        ...
                        <td><a class="btn btn-primary" href="{{url('/user/azmoon/edit/'.$azmoon->id.'/'.$record->id)}}"><i
